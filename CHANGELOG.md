...
User-visible changes per release. The three version manifests (`apps/web/package.json`,
`apps/desktop/electron/package.json`, `apps/desktop/tauri/src-tauri/tauri.conf.json`) are bumped
