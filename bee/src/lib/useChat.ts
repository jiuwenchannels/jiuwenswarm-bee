...
import { config, type GatewayTarget } from './config';
import { GatewayClient, type ChatGateway, type GatewayEvents, type GatewayStatus } from './gateway';
import { ProductGatewayClient } from './gatewayProduct';
import { type AvatarEvent, type AvatarState, nextAvatarState } from './avatar';
import {
  type ChatMessage,
  addUserMessage,
...
export function useChat(): UseChatResult {
  ...
  }, [targetIndex, target.url, target.protocol, applyAvatar, handleError]);
